...
namespace VehicleClassLibrary.Services.DataAccessLayer
{
    public class StoreDAO
    {
        ...
        /// <summary>
        /// Add a vehicle to the shopping cart based on id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
                    ...
                    using (StreamReader reader = new StreamReader(_filePath))
                    {
                        ...
                        switch (parts[0])
                        {
                            case "Car":
                                ...
                                CarModel car = new CarModel(0, make, model, year, price, numWheels, color, miles, isConvertible, trunkSize);
                            ...
                            case "Motorcycle":
                                ...
                                MotorcycleModel motorcycle = new MotorcycleModel(0, make, model, year, price, numWheels, color, miles, hasSideCar, seatHeight);
                            ...
                            case "Pickup":
                                ...
                                PickupModel pickup = new PickupModel(0, make, model, year, price, numWheels, color, miles, hasBedCover, bedSize);
                            ...
                            default:
                                ...
                                VehicleModel vehicle = new VehicleModel(0, make, model, year, price, numWheels, color, miles);
